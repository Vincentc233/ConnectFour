...
public class RedWins implements Screen{
    final Drop setUp;
    Texture redWin = new Texture("Red_Win.png");

    public RedWins(final Drop game){
    ...
    public void render(float delta) {
        ...
        setUp.batch.begin();
        setUp.batch.draw(redWin, 0,0,setUp.worldWidth, setUp.worldHeight);

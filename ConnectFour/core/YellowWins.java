...
public class YellowWins implements Screen{
    final Drop setUp;
    Texture yellowWinTexture = new Texture("Yellow_Win.png");
    public YellowWins (final Drop game){
    ...
    public void render(float delta) {
        ...
        setUp.batch.draw(yellowWinTexture, 0,0,setUp.worldWidth, setUp.worldHeight);
